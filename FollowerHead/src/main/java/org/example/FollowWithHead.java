...
public class FollowWithHead {
    ...
    public void setup() throws InterruptedException {
        ...
        usernameField.sendKeys(uniqueUsername);  // Use the unique username
        ...
        // Step 5: Wait for the signup process to complete
        try {
            Thread.sleep(5000);  // Adjust timing based on actual response time
